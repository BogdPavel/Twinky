...
public:
    ...
    {
        StartWindow->setWindowTitle(QApplication::translate("StartWindow", "Twinky", Q_NULLPTR));
        groupBox->setTitle(QString());
        label->setText(QApplication::translate("StartWindow", "<html><head/><body><p><img src=\":/img/logo.png\" width=\"170\" height=\"170\"/></p></body></html>", Q_NULLPTR));
        label_2->setText(QApplication::translate("StartWindow", "Username", Q_NULLPTR));
        label_3->setText(QApplication::translate("StartWindow", "Password", Q_NULLPTR));
        answerLabel->setText(QString());
        logInButton->setText(QApplication::translate("StartWindow", "Log in", Q_NULLPTR));
        label_4->setText(QApplication::translate("StartWindow", "Don't have an account?", Q_NULLPTR));
        signUpButton->setText(QApplication::translate("StartWindow", "Sign up", Q_NULLPTR));
    } // retranslateUi
